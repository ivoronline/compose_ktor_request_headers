package com.ivoronline.compose_ktor_request_headers
...
suspend fun callURL() : String {
  ...
  //CAL URL
  val httpResponse: HttpResponse = httpClient.get("http://192.168.0.102:8080/SendRequestHeaders") {
    header("username", "myuser"        )
    header("password", "myuserpassword")
  }
